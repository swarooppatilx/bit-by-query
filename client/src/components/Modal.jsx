      ...
      <div className="bg-white p-6 rounded-lg shadow-lg w-3/4 md:w-1/2">
        ...
        <ul className="list-disc pl-5 text-gray-800">
          <ul className="list-disc pl-5 text-gray-800">
            ...
            <li>
              Carefully read each problem statement before attempting a
              solution.
            </li>
            <li>
            ...
            <li>
              For problems involving <b>SELECT</b> queries, provide a single
              query as your solution.
            </li>
            <li>
            ...
            <li>
              When the countdown ends, a <b>Start</b> button will appear. Once
              the competition time is up, you will be redirected to the &quot;Times
              Up&quot; screen.
            </li>
            <li>
              All submissions are evaluated automatically upon submission.
            </li>
